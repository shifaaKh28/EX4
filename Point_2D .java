...
public class Point_2D {
	...
	/* this method that help us in the rotate method 
	 * by this method we find the angle between two segments,based on trigonometry
	 */
	public double angleFromPoints(Point_2D angle) {
		double xx= this.x();
		double yy = this.y();
		
		double dx = angle.x() - xx;
		double dy = angle.y() - yy;
